...
import { Bot, User, AlertCircle, ToggleLeft, ToggleRight } from "lucide-react";
        ...
        {[...Array(6)].map((_, i) => (
          <div
            ...
            className={cn(
              ...
              i % 2 === 0 ? "bg-stone-100" : "bg-red-50 ml-auto"
            )}
          />
        ))}
      </div>
          ...
          >
            ...
            >
              ...
              <p
                className={cn(
                  "text-[10px] mt-1",
                  msg.direction === "incoming" ? "text-stone-400" : "text-red-300"
                )}
              >
